...
const io = new Server(httpServer, {
  cors: {
    origin: ['http://localhost:5173', 'http://localhost:5174', 'https://flowspace-one.vercel.app'],
    credentials: true
  }
})

app.use(cors({ origin: ['http://localhost:3001', 'http://localhost:5174', 'http://localhost:5173', 'https://flowspace-one.vercel.app'], credentials: true }))
